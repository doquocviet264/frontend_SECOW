...
export default function ProductsGrid({ items, viewMode, currentPage, totalPages, onPageChange }: ProductsGridProps) {
  return (
    <div>
      ...
      {totalPages > 0 && (
        <div className="mt-8 flex items-center justify-center gap-2">
           <button
            ...
            <span className="text-sm font-medium text-gray-600 px-2">Trang {currentPage} / {totalPages}</span>
            <button
              onClick={() => onPageChange(currentPage + 1)}
