...
export default function ProductsToolbar({ totalCount, viewMode, onViewModeChange, sortOption, onSortChange }: ProductsToolbarProps) {
  return (
    <div className="bg-white dark:bg-gray-800 p-4 rounded-xl shadow-sm mb-6 flex flex-col sm:flex-row items-center justify-between gap-4">
      <div className="flex flex-col sm:flex-row sm:items-center gap-2">
        <h2 className="text-lg font-bold text-gray-900 dark:text-white">Kết quả tìm kiếm</h2>
      ...
      <div className="flex items-center gap-3 w-full sm:w-auto justify-end">
        ...
        <div className="relative">
          ...
          <span className="material-symbols-outlined absolute right-2 top-1/2 -translate-y-1/2 text-lg text-gray-500 pointer-events-none">expand_more</span>
        </div>
        ...
        <div className="flex bg-gray-100 dark:bg-gray-700 p-1 rounded-lg">
          <button 
            ...
            className={`p-1.5 rounded-md transition-all ${viewMode === 'grid' ? 'bg-white shadow-sm text-blue-600' : 'text-gray-500 hover:text-gray-900'}`}
          >
